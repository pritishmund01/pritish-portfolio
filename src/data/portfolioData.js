...
export const traitsData = [
  {
    ...
    icon: "●",
    accent: "violet",
    description: "Clean fundamentals in data structures, logic, and core engineering."
  },
  {
    id: "exploratory",
    title: "Exploratory",
    icon: "▲",
    accent: "pink",
    description: "Proactively diving into applied AI and distributed systems."
  },
  {
    id: "deliberate",
    title: "Deliberate",
    icon: "■",
    accent: "amber",
    description: "Real implementations and reproducible results over vanity metrics."
  }
];
...
export const projectsData = [
  {
    ...
    chips: ["Android", "Device detection", "Safety Context"],
    iconType: "circle"
  },
  {
    id: "helix-ai",
    ...
    chips: ["CSS", "Applied AI", "Raw Layout"],
    iconType: "helix"
  }
];
...
export const timelineData = [
  {
    ...
    detail: "GIET University, Gunupur — currently in second year, CGPA 8.2.",
    accent: "violet"
  },
  {
    id: "nptel",
  ...
  },
  {
    id: "mysql",
    type: "Workshop",
    title: "MySQL Technical Workshop",
    detail: "Hands-on relational database architecture and querying.",
    accent: "mint"
  },
  {
    id: "freedom-ai",
